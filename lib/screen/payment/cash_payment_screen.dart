  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('✅ Order placed! We’ll notify the provider.'),
        ),
      );
        ...
        child: Column(
          children: [
            Container(
              ...
              child: const Icon(Icons.money, color: Colors.white, size: 40),
            ),
            ...
            Text(
              'You will pay in cash after the service is completed.',
            ...
            ...[
              ...
              ' Receipt provided',
                ...
                .map(
                  (text) => Row(
                children: [
                  const Icon(Icons.check_circle, color: Color(0xFF00457C)),
